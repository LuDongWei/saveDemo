define("#flickslide/1.0.2/flickSlide-debug", [],  function(){
    ...
    return function($) {
        $.fn.flickSlide = function(settings) {
            ...
            function orientationChangeCore() {
                ...
                setTimeout(function() {
                    ...
                    if (styles) {
                        ...
                        maxX = Number($(settings.parentArea + ' .flickSlideContainer li.slideUnit').length - 1) * Number(
                        getComputedStyle($(settings.parentArea + ' .flickSlideContainer li.slideUnit').get(0)).width.replace('px', '')) * -1;
            ...
            for (var i = 0; i < loop; i++) {
                var unitElem = $('<li/>').addClass('slideUnit').
                addClass('resizable');
