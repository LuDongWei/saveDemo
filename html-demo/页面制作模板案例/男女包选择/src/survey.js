...
define(function(require, exports, module) {
  ...
  //初始页面 (默认女生)
  var initial_Html = '<div class="mbb_survey">' +
    '<a href="#" class="mbb_survey_close"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/achieve_10.jpg" /></a>' +
    '<div class="mbb_survey_roll">' +
    '</div>' +
    '<div class="mbb_survey_bar">' +
    '</div>' +
    '</div>';

  var initial_Html_boy = '<div class="mbb_survey mbb_survey_man">' +
    '<a href="#" class="mbb_survey_close"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/achieve_06.jpg" /></a>' +
    '<div class="mbb_survey_roll">' +
    '</div>' +
    '<div class="mbb_survey_bar">' +
    '</div>' +
  ...
  //女生最后一题
  var three_Html_ = '<div class="mbb_survey_content">' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_01.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_02.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_choose mbb_survey_choose_more">' +
    '<ul>' +
    '<li><a href="#"   data-id="0" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_04.jpg" /></a></li>' +
    '<li><a href="#"   data-id="1" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_05.jpg" /></a></li>' +
    '<li><a href="#"   data-id="2" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_06.jpg" /></a></li>' +
    '<li><a href="#"   data-id="3" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_07.jpg" /></a></li>' +
    '<li><a href="#"   data-id="4" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_08.jpg" /></a></li>' +
    '<li><a href="#"   data-id="5" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_09.jpg" /></a></li>' +
    '<li><a href="#"   data-id="6" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_10.jpg" /></a></li>' +
    '<li><a href="#"   data-id="7" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_11.jpg" /></a></li>' +
    '</ul>' +
    '</div>' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_12.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_choose mbb_survey_choose_long">' +
    '<ul style="float:left; margin-left:41px;">' +
    '<li><a href="#"   data-id="0" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_13.jpg" /></a></li>' +
    '<li><a href="#"   data-id="1" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_14.jpg" /></a></li>' +
    '<li><a href="#"   data-id="2" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_15.jpg" /></a></li>' +
    '<li><a href="#"   data-id="3" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_16.jpg" /></a></li>' +
    '<li><a href="#"   data-id="4" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_17.jpg" /></a></li>' +
    '</ul>' +
    '</div>' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_18.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_choose mbb_survey_choose_size">' +
    '<ul style="float:left; margin-left:41px;">' +
    '<li><a href="#"   data-id="0" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_19.jpg" /></a></li>' +
    '<li><a href="#"   data-id="1" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_20.jpg" /></a></li>' +
    '<li><a href="#"   data-id="2" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_21.jpg" /></a></li>' +
    '<li><a href="#"   data-id="3" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_22.jpg" /></a></li>' +
    '<li><a href="#"   data-id="4" ><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_23.jpg" /></a></li>' +
    '</ul>' +
    '</div>' +
    '<a href="#" class="mbb_survey_submit"><span>亲，还木有完成哦(*^__^*)</span><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/08/title_07_24.jpg" /></a>' +
    '</div>';

  //男生最后一题
  var three_Html_boy_ ='<div class="mbb_survey_content">' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_01.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_02.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_choose mbb_survey_choose_more">' +
    '<ul>' +
    '<li><a href="#"   data-id="0"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_04.jpg" /></a></li>' +
    '<li><a href="#"   data-id="1"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_06.jpg" /></a></li>' +
    '<li><a href="#"   data-id="2"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_07.jpg" /></a></li>' +
    '<li><a href="#"   data-id="3"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_08.jpg" /></a></li>' +
    '<li><a href="#"   data-id="4"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_09.jpg" /></a></li>' +
    '</ul>' +
    '</div>' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_03.jpg?2013" />' +
    '</div>' +
    '<div class="mbb_survey_choose mbb_survey_choose_long">' +
    '<ul style="float:left; margin-left:41px;">' +
          '<li class="long_01"><a  href="#"   data-id="0">●&nbsp;&nbsp;款式</a></li>' +
          '<li class="long_02"><a  href="#"   data-id="1">●&nbsp;&nbsp;材质</a></li>' +
          '<li class="long_03"><a  href="#"   data-id="2">●&nbsp;&nbsp;价格</a></li>' +
          '<li class="long_04"><a  href="#"   data-id="3">●&nbsp;&nbsp;颜色</a></li>' +
          '<li class="long_05"><a  href="#"   data-id="4">●&nbsp;&nbsp;功能</a></li>' +
          '<li class="long_06"><a  href="#"   data-id="5">●&nbsp;&nbsp;风格</a></li>' +
          '<li class="long_07"><a  href="#"   data-id="6">●&nbsp;&nbsp;容量</a></li>' +
          '<li class="long_08"><a  href="#"   data-id="7">●&nbsp;&nbsp;性价比</a></li>' +
          '<li class="long_09"><a  href="#"   data-id="8">●&nbsp;&nbsp;品牌</a></li>' +
          '<li class="long_10"><a  href="#"   data-id="9">●&nbsp;&nbsp;质量</a></li>' +
    '</ul>' +
    '</div>' +
    '<div class="mbb_survey_head">' +
    '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_05.jpg" />' +
    '</div>' +
    '<div class="mbb_survey_choose mbb_survey_choose_size">' +
    '<ul style="float:left; margin-left:41px;">' +
    '<li><a href="#"   data-id="0"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_21.jpg" /></a></li>' +
    '<li><a href="#"   data-id="1"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_22.jpg" /></a></li>' +
    '<li><a href="#"   data-id="2"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_23.jpg" /></a></li>' +
    '<li><a href="#"   data-id="3"><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_24.jpg" /></a></li>' +
    '</ul>' +
    '</div>' +
    '<a href="#" class="mbb_survey_submit"><span>亲，还木有完成哦(*^__^*)</span><img src="http://cca.mbaobao.com/mkts/201311/15/survey/img2/05/title_05_25.jpg" /></a></div>';
  ...
  var one_Html = function(data,data_id_) {
    ...
    for (var i = 0; i < 5; i++) {
      if (i === 0) {
        N01 = '<div class="mbb_survey_head">' +
          '<img src=' + now_survey_img[i] + ' />' +
          '</div>';
      } else {
  ...
  var two_Html_ = function(abc) {
    var two_Html = '';
    var N01 = '<div class="mbb_survey_head">' +
      '<img src="http://cca.mbaobao.com/mkts/201311/15/survey/img/06/title_06_01.jpg" />' +
      '</div>';
    var N02 = '';
    var check = [];
  ...
  var saveanswer = function(abc) {
    var survey_left = survey_sum * 960; //滚动长度
    answer.push(abc); //记录答案
    var n = survey_sum++; //下一题
